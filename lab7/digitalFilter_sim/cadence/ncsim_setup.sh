...
# ACDS 12.1sp1 243 win32 2019.11.16.17:56:34
...
if [ $SKIP_DEV_COM -eq 0 ]; then
  ...
  ncvhdl -v93 "c:/altera/12.1sp1/quartus/eda/sim_lib/cycloneiii_atoms.vhd"             -work cycloneiii      
  ncvhdl -v93 "c:/altera/12.1sp1/quartus/eda/sim_lib/cycloneiii_components.vhd"        -work cycloneiii      
fi
...
if [ $SKIP_COM -eq 0 ]; then
  ...
  ncvhdl -v93 "$QSYS_SIMDIR/digitalFilter_rtl.vhd"                          
  ncvhdl -v93 "$QSYS_SIMDIR/digitalFilter_ast.vhd"                          
  ncvhdl -v93 "$QSYS_SIMDIR/digitalFilter.vhd"                              
  ncvhdl -v93 "$QSYS_SIMDIR/digitalFilter_tb.vhd"                           
fi
