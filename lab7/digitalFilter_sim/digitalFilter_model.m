...
for j = 1:sx
    ...
    %
    file_name = ['digitalFilter_input.txt'];
    ...
    for i = 1: num_ch
     ...
     % run this output through the model 
      if(bankcount>1)
        output = digitalFilter_mlab(data_channel, bank_channel);
      else
        output = digitalFilter_mlab(data_channel);
      end
    ...
    file_name = ['digitalFilter_model_output'];
