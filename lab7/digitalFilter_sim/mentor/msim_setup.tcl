...
# ACDS 12.1sp1 243 win32 2019.11.16.17:56:31
...
if ![info exists TOP_LEVEL_NAME] { 
  set TOP_LEVEL_NAME "digitalFilter"
...
alias dev_com {
  ...
  if { ![ string match "*ModelSim ALTERA*" [ vsim -version ] ] } {
    ...
    vlog -sv "c:/altera/12.1sp1/quartus/eda/sim_lib/mentor/altera_lnsim_for_vhdl.sv"  -work altera_lnsim_ver
    ...
    vcom     "c:/altera/12.1sp1/quartus/eda/sim_lib/cycloneiii_atoms.vhd"             -work cycloneiii      
    vcom     "c:/altera/12.1sp1/quartus/eda/sim_lib/cycloneiii_components.vhd"        -work cycloneiii      
  }
}
...
alias com {
  ...
  vcom "$QSYS_SIMDIR/digitalFilter_rtl.vhd"                          
  vcom "$QSYS_SIMDIR/digitalFilter_ast.vhd"                          
  vcom "$QSYS_SIMDIR/digitalFilter.vhd"                              
  vcom "$QSYS_SIMDIR/digitalFilter_tb.vhd"                           
}
