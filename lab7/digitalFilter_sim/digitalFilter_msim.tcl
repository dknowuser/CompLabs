...
transcript on
write transcript digitalFilter_transcript

# START MEGAWIZARD INSERT VARIABLES
set top_entity digitalFilter
set timing_resolution "1ps"
set core_version 12.1
set device_family CYCLONEIII
set quartus_rootdir C:/altera/12.1sp1/quartus/
...
if {[string match $flow "rtl"] } {
    ...
    if {[file exists digitalFilter.vhd]} {vcom -93 -work work digitalFilter.vhd}
    if {[file exists digitalFilter.v]} {vlog -work work digitalFilter.v}
    vcom -93 -work work digitalFilter_ast.vhd
    vcom -93 -work work digitalFilter_rtl.vhd
