...
ARCHITECTURE structure OF labka13 IS
...
-- Equation(s):
-- \out~0_combout\ = (\x[1]~input_o\ & (((\x[3]~input_o\ & !\x[0]~input_o\)) # (!\x[2]~input_o\))) # (!\x[1]~input_o\ & (!\x[3]~input_o\ & (\x[0]~input_o\)))
